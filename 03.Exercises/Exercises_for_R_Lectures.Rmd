...
2. Now open the file called 'Student_Exercises_for_Workshop_Lectures.Rmd'. This file will serve as your digital notebook for parts of the workshop and contains the other exercises.
...
- Create a new directory on the terminal usig `mkdir directory_name` and clone the evomics_stat_2019 repo into that directory using the command 'git clone https://github.com/wcresko/evomics_stat_2019.git'
...
6. Open a new Rmarkdown `flex dashboard` template and create a multi panel figure of your choice.