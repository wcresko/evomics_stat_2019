...
## _Exercise 3.2: Examining Normally Distributed Data_
...
##_Exercise 3.3: An example of creating your own function to model forward and reverse mutation equilibrium_
...
##_Exercise 3.5: Test for Hardy Weinberg Equilibrium in a two-allele model using a Chi-square_
...
## _Exercise 3.6: Linear Models to examine the relationship of different hormone and thyroid morphology levels in stickleback fish_
...
## _Exercise 4.1: 2-by-2 fixed effect factorial ANOVA examining the effects of microbiome treatment on RNA expression levels in the guts of threespine stickleback_
...
## _Exercise 4.2: NMDS for the analysis of multivariate data_
...
## _Exercise 4.3: Biodiversity analysis in R - pulling it all together_
