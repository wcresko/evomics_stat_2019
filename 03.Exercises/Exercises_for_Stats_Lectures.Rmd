...
##_Exercise 3.5: Test for Hardy Weinberg Equilibrium in a two-allele model using a Chi-square statistical distribution_
...
## _Exercise 3.6: Linear Models to examine the relationship of different hormone levels and thyroid morphology in zebrafish_
...
## _Exercise 3.7: Multiple linear regression_
...
## _Exercise 3.8: 2-by-2 fixed effect factorial ANOVA examining the effects of microbiome treatment on RNA expression levels in the guts of threespine stickleback_
...
6. We can run a PCA on our data as well.
...
```
- What are these plots showing? What is in red? What is in black?
...
## _Exercise 3.10: Biodiversity analysis in R - pulling it all together_
