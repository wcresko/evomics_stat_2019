...
# Now it's time for you to use what you've learned and apply it to basic population genetics.
# Questions: Can you use the assignment and math operations to answer the following questions?


# 1. How do binomial distributions change with variation in the number of observations,
# and the size of each sample?


# 2. Can you plot the expected genotype frequencies (p2 2pq and q2) under HWE for every value of p from 0 to 1.0 in increments of 0.1?


# 3. Can you calculate the observed allele and genotype frequencies for the following genotype counts in a population of Monkeyflowers, and then estimate the expected genotype frequencies?
...
#4. How about for the following population?
