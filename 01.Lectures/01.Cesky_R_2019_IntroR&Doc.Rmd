...
- Now open the file called *Student_Exercises_for_Workshop_Lectures.Rmd*. 
...
## Exercise 1.2 - `R Markdown` Files

- Take a few minutes to familiarize yourself with RMarkdown Files
...
# Working with 'Real' Datasets in `R`
